...
class Visitor(object):
    ...
    -- OR --
    child class may implement `visit_bin_op` and `visit_unary_op` such
    that no arithmetic is performed on `None` values
    TODO separate base class from a child class to perform calculations
    '''
    GLOBAL_SCOPE = {}
